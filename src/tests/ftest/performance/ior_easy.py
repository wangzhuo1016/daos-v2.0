...
class IorEasy(PerformanceTestBase):
    ...
    def test_performance_ior_easy_dfs_ec_16p2gx(self):
        ...
        :avocado: tags=performance_ior_easy,performance_ior_easy_dfs_ec_16p2gx
        """
    ...
    def test_performance_ior_easy_dfs_rp_2gx_stop_write(self):
        ...
        :avocado: tags=hw,large
        :avocado: tags=performance
        :avocado: tags=performance_ior_easy,performance_ior_easy_dfs_rp_2gx_stop_write
        """
    ...
    def test_performance_ior_easy_dfs_ec_2p2gx_stop_write_read(self):
        ...
        :avocado: tags=hw,large
        :avocado: tags=performance,ior,dfs
        :avocado: tags=performance_ior_easy,performance_ior_easy_dfs_ec_2p2gx_stop_write_read
        """
        self.run_performance_ior(
    ...
    def test_performance_ior_easy_dfs_ec_16p2gx_stop_write_read(self):
        ...
        :avocado: tags=hw,large
        :avocado: tags=performance
        :avocado: tags=performance_ior_easy,performance_ior_easy_dfs_ec_16p2gx_stop_write_read
        """
        self.run_performance_ior(
