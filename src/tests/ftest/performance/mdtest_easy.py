...
class MdtestEasy(PerformanceTestBase):
    ...
    def test_performance_mdtest_easy_dfs_sx(self):
        ...
        :avocado: tags=performance_mdtest_easy,performance_mdtest_easy_dfs_sx
        """
    ...
    def test_performance_mdtest_easy_dfs_ec_16p2gx(self):
        ...
        :avocado: tags=performance_mdtest_easy,performance_mdtest_easy_dfs_ec_16p2gx
        """
    ...
    def test_performance_mdtest_easy_dfs_rp_2gx_stop(self):
        ...
        :avocado: tags=hw,large
        :avocado: tags=performance,mdtest,dfs
        :avocado: tags=performance_mdtest_easy,performance_mdtest_easy_dfs_rp_2gx_stop
        """
    ...
    def test_performance_mdtest_easy_dfs_ec_16p2gx_stop(self):
        ...
        :avocado: tags=hw,large
        :avocado: tags=performance
        :avocado: tags=performance_mdtest_easy,performance_mdtest_easy_dfs_ec_16p2gx_stop
        """
        self.run_performance_mdtest(
