...
class DaosServerManager(SubprocessManager):
    ...
    def autosize_pool_params(self, size, tier_ratio, scm_size, nvme_size,
        ...
        Args:
            size (object): the str, int, or None value for the dmp pool create size parameter.
            tier_ratio (object): the int or None value for the dmp pool create size parameter.
